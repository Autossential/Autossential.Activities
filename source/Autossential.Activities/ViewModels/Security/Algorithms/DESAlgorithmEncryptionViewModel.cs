...
{
    internal class DESAlgorithmEncryptionViewModel : BaseViewModel
    {
        public DESAlgorithmEncryptionViewModel(IDesignServices services) : base(services)
        {
        }
        ...
        protected override void InitializeModel()
        {
            ...
            if (IsWidgetSupported(ViewModelWidgetType.TextBlock))
            {
                ...
                Warning.Value = "Legacy algorithm. Use DES only for compatibility with legacy applications and data.";
