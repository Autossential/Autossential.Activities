...
{
    internal class RC2AlgorithmEncryptionViewModel : BaseViewModel
    {
        public RC2AlgorithmEncryptionViewModel(IDesignServices services) : base(services)
        {
        }
        ...
        protected override void InitializeModel()
        {
            ...
            if (IsWidgetSupported(ViewModelWidgetType.TextBlock))
            {
                ...
                Warning.Value = "Legacy algorithm. Use RC2 only for compatibility with legacy applications and data.";
