...
{
    internal class RijndaelAlgorithmEncryptionViewModel : BaseViewModel
    {
        public RijndaelAlgorithmEncryptionViewModel(IDesignServices services) : base(services)
        {
        }
        ...
        protected override void InitializeModel()
        {
            ...
            if (IsWidgetSupported(ViewModelWidgetType.TextBlock))
            {
                ...
                Warning.Value = "Legacy algorithm. Use Rijndael only for compatibility with legacy applications and data.";
